...
import cn.rongcloud.oklib.api.FormType;
import cn.rongcloud.oklib.api.body.IBody;
import cn.rongcloud.oklib.wrapper.OkUtil;
...
public class Transform {
    ...
    public static String urlAppendParam(String url, Map<String, Object> params) {
        ...
        OkUtil.e("Transform","urlAppendParam:"+result);
        return result;
    }
